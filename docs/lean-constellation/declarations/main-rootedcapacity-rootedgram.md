...
The rational Gram matrix obtained by scalar-extending the repository tree pairing.

- Kind: `definition`
- Node: `Main.RootedCapacity`
- Module: `PositiveDefiniteTreeLattice.Main.RootedCapacity.Defs.rootedGram`
- State: `declared`
