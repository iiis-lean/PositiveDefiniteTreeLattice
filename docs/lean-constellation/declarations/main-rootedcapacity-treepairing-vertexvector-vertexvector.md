...
The tree pairing of two basis vertex vectors is diagonal weight, minus one on an edge, and zero otherwise.

- Kind: `theorem`
- Node: `Main.RootedCapacity`
- Module: `PositiveDefiniteTreeLattice.Main.RootedCapacity.Theorems.treePairing_vertexVector_vertexVector`
- State: `proved`
